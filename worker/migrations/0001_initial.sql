...
CREATE INDEX IF NOT EXISTS idx_bounties_funding_status ON bounties(funding_status);
CREATE INDEX IF NOT EXISTS idx_bounties_momentum ON bounties(momentum_score);
...
CREATE INDEX IF NOT EXISTS idx_boosts_bounty_id ON boosts(bounty_id);
CREATE INDEX IF NOT EXISTS idx_boosts_submission_id ON boosts(submission_id);
CREATE INDEX IF NOT EXISTS idx_support_events_user_id ON support_events(user_id);
CREATE INDEX IF NOT EXISTS idx_support_events_target ON support_events(target_type, target_id);
CREATE INDEX IF NOT EXISTS idx_curated_items_type_placement ON curated_items(item_type, placement);
